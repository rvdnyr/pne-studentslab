# EXERCISE 7
# Write a Python program that creates three sequences: one null, one valid, and one invalid, and then prints their lengths, sequences, the dictionary with the bases, and the reverse sequence.
